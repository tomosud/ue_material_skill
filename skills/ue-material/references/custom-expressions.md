...
Evidence ID: `fixture:roundtrip/custom-lumasplit`. The distributable skill records the result; the development
repository retains the raw input and Editor copy-back fixtures.
