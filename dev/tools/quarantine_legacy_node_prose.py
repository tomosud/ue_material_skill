...
DEFAULT_EVIDENCE = SKILL_ROOT / "catalog" / "node-evidence.json"
DEFAULT_OUTPUT = SKILL_ROOT / "catalog" / "legacy-node-prose.json"
...
def main() -> int:
    ...
    output = {
        ...
        "source_evidence": str(args.evidence.relative_to(SKILL_ROOT)).replace("\\", "/"),
