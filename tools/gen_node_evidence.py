...
DEFAULT_MANIFEST = PROJECT_ROOT / "catalog" / "manifest.json"
DEFAULT_OUTPUT = PROJECT_ROOT / "skill" / "catalog" / "node-evidence.json"
DEFAULT_AUDITS = PROJECT_ROOT / "skill" / "catalog" / "audits"
